...
public class UploadUtils {
	...
	public static final DateFormat MILLISECONDS_FORMAT = new SimpleDateFormat(
			"yyyyMMddHHmmssSSS");
	...
	public static String generateFilename() {
		DateFormat TIME_FORMAT = new SimpleDateFormat(
				"yyyyMMddHHmmss");
		return TIME_FORMAT.toString() +  RandomStringUtils.random(4, Num62.N36_CHARS);
	}
	...
	public static String generateMD5Filename(String path, String ext) {
		Md5PwdEncoder Md5 = new Md5PwdEncoder(); 
		if(StringUtils.isBlank(ext)){
			return path + MONTH_FORMAT.format(new Date())
				+ Md5.encodePassword(RandomStringUtils.random(4, Num62.N36_CHARS)).toUpperCase();
		}else{
			return path + MONTH_FORMAT.format(new Date())
					+ Md5.encodePassword(RandomStringUtils.random(4, Num62.N36_CHARS)).toUpperCase() + "." + ext;
		}
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(generateMonthname());
	}
