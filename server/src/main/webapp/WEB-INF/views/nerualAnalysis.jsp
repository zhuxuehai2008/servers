...
<body>
	...
	隐含层最大数量(最小4)<input type ="text"  placeholder="隐含层最大数量" value="20">
			        ...
			        error: function(XMLHttpRequest, textStatus, errorThrown){
			        	alert(textStatus);
							  ...
							  function interval(){
									...
									if(width==100){
										console.log(result);
										option.series.data=result.map(function (item) {return {value: [item["serialNum"], item["hiddenNum"], item["value"]],}});
										option.xAxis3D= serialArr;
										option.yAxis3D= hiddenArr;
										form_chart.setOption(option);
										console.log("@");
