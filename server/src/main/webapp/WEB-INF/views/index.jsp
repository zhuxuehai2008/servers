...
<section class="rt_wrap content mCustomScrollbar">
 ...
 <div class="rt_content">
     ...
     <h1 style="color:red;font-size:20px;font-weight:bold;text-align:center;">相关版块涉及样式示例文档（先留着 不用做也不用显示，以后再说）</h1>
...
<script src="<%=path %>/static/js/amcharts.js" type="text/javascript"></script>
<script src="<%=path %>/static/js/serial.js" type="text/javascript"></script>
<script src="<%=path %>/static/js/pie.js" type="text/javascript"></script>
